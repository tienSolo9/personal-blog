                                ...
                                <c:forEach var="it" items="${articles}">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/admin/article/create/${it.id}">
                                                <i class="fa-solid fa-pen"></i>
                                            </a>

                                            <a href="/admin/article/delete/${it.id}"><i class="fa-solid fa-trash"></i>
                                            </a>
                            ...
                            <nav aria-label="Page navigation example" style="position: fixed;top:500px">
                                <ul class="pagination">
                                    <li class="page-item  ${currentPage eq 1 ? 'disabled':''}">
                                        <a class="page-link" href="/admin/article?page=${currentPage-1}"
                                            aria-label="Previous">
                                    ...
                                    <c:forEach begin="0" end="${totalPage - 1}" varStatus="s">
                                        <li class="page-item">
                                            <a class="page-link"
                                                href="/admin/article?page=${s.index+1}">${s.index+1}</a>
                                        </li>
                                    </c:forEach>
